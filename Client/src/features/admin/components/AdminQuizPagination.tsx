...
export function AdminQuizPagination({
  page,
  pageSize,
  total,
  onPageChange,
    ...
    <div className="flex flex-col gap-space-sm border border-outline-variant/40 bg-surface-container-lowest px-space-md py-space-sm sm:flex-row sm:items-center sm:justify-between">
      ...
      <div className="flex items-center gap-1">
        <button
          ...
          className="font-label inline-flex items-center px-space-sm py-space-xs text-label-md uppercase disabled:opacity-40"
        >
